...
int main()
{
	...
	if((T1Img = cvLoadImage("img1.png", CV_LOAD_IMAGE_GRAYSCALE)) == NULL)
	{
	...
	if((T2Img = cvLoadImage("img2.png", CV_LOAD_IMAGE_GRAYSCALE)) == NULL)
	{
	...
	{
		//¸ÅÄª k¹øÂ°ÀÇ T1, T2¿¡¼­ÀÇ Å° Æ÷ÀÎÆ® Á¤º¸ »Ì±â
